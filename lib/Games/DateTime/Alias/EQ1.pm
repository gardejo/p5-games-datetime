package Games::DateTime::Alias::EQ1;
...
around _build_alias => sub {
    ...
    my @aliases = qw(
        ...
        eq_1            eq_i
        everquest
        everquest1      everquesti
        everquest_1     everquest_i
        norrath
    );
    @$alias{@aliases} = ('EQ1') x scalar @aliases;
...
Games::DateTime::Alias::EQ2 - Aliases of EverQuest
...
This class provides default aliases of EverQuest
