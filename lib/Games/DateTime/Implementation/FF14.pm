package Games::DateTime::Implementation::FF14;
...
Games::DateTime::Implementation::FF14 - Implementation of Final Fantasy XIV for Games::DateTime

=head1 SYNOPSIS

    use Games::DateTime;

    my $ff14_datetime = Games::DateTime->create('FF14');
    printf (
        "Eorzea has %d days in a week.",
            $ff14_datetime->days_in_a_week,
    );

=head1 DESCRIPTION

This class provides several constants of Final Fantasy XIV
