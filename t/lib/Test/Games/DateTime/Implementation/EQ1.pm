...
Test::Games::DateTime::Implementation::EQ1 - Test for Games::DateTime::Implementation::EQ1
...
This class tests L<Games::DateTime::Implementation::EQ1|
Games::DateTime::Implementation::EQ1>.
